...
function geoFindMe() {
  ...
  function success(position) {
    ...
    status.textContent = '';
    mapLink.href = `https://bing.com/maps/default.aspx?cp=${latitude}~${longitude}&lvl=18&style=r`;
...
<br><br><a href="gpstracker2.php" style="font-size: 350%;">หน้าต่อไป OpenStreetMap</a>
